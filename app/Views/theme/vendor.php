    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href="<?=base_url().$member?>/profile/edit-profile"><i class="bx bx-right-arrow-alt"></i>Edit Profile</a></li>
        ...
        <li>
            ...
            <ul>
                <li><a href="<?=base_url().$member?>/ad/new"><i class="bx bx-right-arrow-alt"></i>New Ad</a></li>
                <li><a href="<?=base_url().$member?>/ad/approved"><i class="bx bx-right-arrow-alt"></i>Approved Ad</a></li>
                <li><a href="<?=base_url().$member?>/ad/pending"><i class="bx bx-right-arrow-alt"></i>Pending Ad</a></li>
            </ul>
        </li>
